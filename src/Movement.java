...
public class Movement extends Thread
{
   ...
   public void turn(int angle)
   {
      ...
      while (true)
      {
         if (angle > 0 && MotorPort.C.getTachoCount() > Math.abs(angle) * this.wheelsSpacing / this.wheelsRadius)
            break;
         if (angle < 0 && MotorPort.B.getTachoCount() > Math.abs(angle) * this.wheelsSpacing / this.wheelsRadius)
            break;
      }
   ...
   /**
    * If DEBUG_MODE == true Test if TachoCounter is set up correctly. You should manually check if wheel made a full
    * rotation
    */
